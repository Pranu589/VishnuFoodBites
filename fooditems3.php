...
$shop_id = 3;
$stmt = $conn->prepare("SELECT item_id, item_name, item_image, price, stock_status FROM Food_Items WHERE shop_id = ?");
...
$shop_name = $shop ? $shop['shop_name'] : 'Shop';
$stmt->close();
?>
...
<head>
    ...
    <title><?php echo htmlspecialchars($shop_name); ?> - Vishnu Food Bites</title>
...
<body>
    ...
    <h1>JUICY DRINKS</h1>
    <h3>Timings: 10:00AM - 6:30PM (Sun-Sat)</h3>
    ...
    <script>
        ...
        document.querySelectorAll('.add-to-cart').forEach(button => {
            ...
            button.addEventListener('click', () => {
                ...
                console.log('Add to Cart clicked:', { itemId, itemName, itemPrice, shopId });
